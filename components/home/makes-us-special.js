...
const MakesUsSpecial = props => {
  return (
    <div className="px-9 pt-[5.625rem] pb-[6.125rem] lg:pt-[12.435rem] lg:pb-[14.5rem] relative">
      <div className="max-w-[85.25rem] mx-auto flex flex-col lg:flex-row gap-y-[2.625rem] lg:gap-x-9 xl:gap-x-28 2xl:gap-x-[8.5rem]">
        ...
        <div className="flex-1 lg:grid lg:grid-cols-2 lg:gap-y-[4.0625rem] 2xl:gap-y-[4.1875rem] lg:gap-x-[4rem] 2xl:gap-x-[5.3125rem]">
          ...
          <div className="absolute md:hidden lg:block left-0 md:left-[1%] top-[0%] md:top-[10%] 2xl:top-0">
          <Image src='/images/patterns/pattern-6.svg' alt='pattern' width={50} height={50} className="w-24 h-24 lg:w-28 lg:h-28 blur-[8px]" priority />
          </div> 
          <div className="absolute hidden xl:block right-[0%] 2xl:right-[5%] bottom-[5%]">
          <Image src='/images/patterns/pattern-7.svg' alt='pattern' width={50} height={50} className="w-24 h-24 lg:w-28 lg:h-28 blur-[8px]" priority />
          </div> 
