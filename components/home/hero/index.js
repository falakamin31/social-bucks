...
const Hero = props => {
    return (
        <div className="bg-dark-black pt-24 lg:pt-[9.1875rem] relative">
            {/* Patterns  */}
            <div className="absolute -top-[0%] lg:top-[5%] right-0 lg:right-[3%]">
                <Image src='/images/patterns/pattern-1.svg' alt='pattern' width={50} height={50} className="w-24 h-24 lg:w-32 lg:h-32 blur-[8px]" priority/>
            </div>
            <div className="absolute top-[28%] -left-4">
                <Image src='/images/patterns/pattern-2.svg' alt='pattern' width={50} height={50} className="w-16 h-16 lg:w-24 lg:h-24 blur-[8px]" priority/>
            </div>
